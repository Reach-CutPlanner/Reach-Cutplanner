    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-lg text-gray-700 max-w-3xl mx-auto mb-12">
          When compared to manual methods or general-purpose graphic design software 
          like Adobe Illustrator, REACH Cut Planner stands out as the ultimate 
          choice for fashion professionals.
        </p>
          ...
          <table className="w-full text-left text-lg">
            <thead className="bg-gray-100 text-gray-800">
              <tr>
                ...
                <th className="py-4 px-6 font-semibold text-primary">
                  REACH CUT PLANNER
                </th>
              </tr>
            </thead>
